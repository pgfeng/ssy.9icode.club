...
<script type="text/javascript">
    ...
    BUI.use(['bui/grid','bui/data'],function(Grid,Data){
        var Grid = Grid,
            ...
            data = <?php echo isset($form)?$form:$this->var['form'];?>;
        ...
        function addFunction(){
            location.href='<?php echo url('Form/setting/add');?>';
        }
        //删除选中的记录
                ...
                buttons : [
                    {
                        ...
                        handler : function(){
                            ...
                            var url = '<?php echo url('Form/setting/del');?>';
                            $.post(url,{
                                'formid':$id
                            },function(data){
                                data=JSON.parse(data);
                                if (data.status == 'true') {
                                    location.href = '<?php echo url('Form/setting');?>';
                                } else {
                                    data.status = 'error';
        ...
        editing.on('accept',function () {
            ...
            $.post('<?php echo url('Form/setting/edit');?>',{
