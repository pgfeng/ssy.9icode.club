...
<script type="text/javascript">
    BUI.use(['bui/grid', 'bui/data'], function (Grid, Data) {
        ...
        //默认的数据
            data =<?php echo isset($data)?$data:$this->var['data'];?>,
        ...
        editing.on('accept', function (editing) {
            ...
            {
                var url = '<?php echo url('Module/manage/edit');?>' + '?' + new Date().getTime();
                ...
                var url = '<?php echo url('Module/manage/add');?>' + '?' + new Date().getTime();
                    ...
                    buttons : [
                        {
                            ...
                            handler : function(){
                                ...
                                var url = '<?php echo url('Module/manage/del');?>';
        ...
        grid.on('cellclick', function (ev) {
            ...
            if (target.hasClass('btn-manage')) {
                ...
                window.location.href='<?php echo url('Module/manage/field');?>?mid='+record.id;
            }
            /**
            if (target.hasClass('btn-del')) {
                var url = '<?php echo url('Index/admin_manage/del');?>' + '?' + new Date().getTime();
