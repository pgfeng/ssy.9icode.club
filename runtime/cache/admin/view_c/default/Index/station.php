        ...
        <div class="span21 offset1 doc-content">
            <table cellspacing="0" class="table table-bordered">
                ...
                <tr>
                    ...
                    <td colspan="2" class="text-left"><?php echo isset($realname)?$realname:$this->var['realname'];?></td>
                    <td class="text-right span3">所属角色：</td>
                    <td colspan="2" colspan="2" class="text-left"><?php echo isset($rolename)?$rolename:$this->var['rolename'];?></td>
                </tr>
                <tr>
                    <td class="text-right">上次登录时间：</td>
                    <td colspan="2" class="text-left"><?php echo date("Y-m-d H:i:s",$lastlogintime);?></td>
                    <td class="text-right">上次登录IP：</td>
                    <td colspan="2"><?php echo isset($lastloginip)?$lastloginip:$this->var['lastloginip'];?></td>
                </tr>
                <tr>
                    <td class="text-right">操作系统：</td>
                    <td colspan="2" class="text-left"><?php echo PHP_OS;?></td>
