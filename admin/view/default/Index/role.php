...
<div class="row" style="margin-top: 10px">
    ...
    <div id="roleset" class="hide span1">
        <div class="span9">
            ...
            <form action="<{url('Index/role/editrole')}>" method="post" id="editrole">
    ...
    <script type="text/javascript">
        BUI.use(['bui/grid', 'bui/data'], function (Grid, Data) {
            ...
            //默认的数据
                data =<php> echo json_encode($table); </php>,
            ...
            editing.on('accept', function (editing) {
                ...
                {
                    var url = '<{url('Index/role/edit')}>' + '?' + new Date().getTime();
                    $.post(url, {
                    ...
                    var url = '<{url('Index/role/add')}>' + '?' + new Date().getTime();
            ...
            function updateFunction(roleid) {
                ...
                BUI.use('bui/tree', function (Tree) {
                    BUI.use('bui/overlay', function (Overlay) {
                        var data =<{module('admin')->treemenu()}>;
                        ...
                        buttons : [
                            {
                                ...
                                handler : function(){
                                    var url = '<{url('Index/role/del')}>' + '?' + new Date().getTime();
