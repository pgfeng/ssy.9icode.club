...
<head>
    ...
    <{includeScript 'jquery-1.8.1.min.js'}>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var bg='url(<{$view_vars['public_path']}>img/login/bg_'+random_bg+'.jpg)';
...
<div class="login-layout">
    ...
    <div class="box">
      ...
      <div class="code">
          <div class="arrow"></div>
          <div class="code-img"><img src="<{url('Use/checkcode')}>" name="codeimage" id="codeimage" border="0"/></div>
          <a href="JavaScript:void(0);" id="hide" class="close" title="关闭"><i></i></a><a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='<{url('Use/checkcode')}>?&t=' + Math.random();" class="change" title="看不清,点击更换验证码"><i></i></a> </div>
