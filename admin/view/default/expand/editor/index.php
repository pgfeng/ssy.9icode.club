<?php
$curr_file = Config::cms('cms_path').Config::cms('view_dir').'/'.Config::cms('view_name').'/'.'index.php'; //默认编辑首页
$curr_file_path = str_replace(dirname($curr_file), '', $curr_file);
//echo $curr_file_path;exit;
$pwd = true; //密码初始化默认值为 false
$ace['core'] = '//cdn.staticfile.org/ace/1.1.3/ace.js'; //编辑器核心js
$ace['ext-emmet'] = '//cdn.staticfile.org/ace/1.1.3/ext-emmet.js';
$ace['ext-language'] = '//cdn.staticfile.org/ace/1.1.3/ext-language_tools.js';
$ace['snippets-php'] = '//cdn.staticfile.org/ace/1.1.3/snippets/php.js';
$tip['core'] = '//cdn.staticfile.org/alertify.js/0.3.11/alertify.core.min.css';
$tip['css'] = '//cdn.staticfile.org/alertify.js/0.3.11/alertify.default.min.css';
$tip['js'] = '//cdn.staticfile.org/alertify.js/0.3.11/alertify.min.js';
$jquery = '//cdn.staticfile.org/jquery/2.1.1-rc2/jquery.min.js';
//文件后缀名对应的语法解析器
$lng = array(
...
form input {
    color: #f9f9ff; border: 1px solid #369; border-radius: 3px; background: #333; height: 22px;
...
form button {
    ...
    background: #369; color: #f9f9ff; vertical-align: middle;
}
</style>
...
<!DOCTYPE html>
<html><head><meta charset="UTF-8">
<title>GouWanMei 在线模板编辑器</title>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
<style type="text/css" media="screen">
a { text-decoration: none; }
body {
	overflow: hidden; background-color:#f9f9ff; color: #444; font-size: 12px;
	font-family: 'Consolas', 'Monaco', 'Menlo', 'Ubuntu Mono', monospace;
    scrollbar-arrow-color: #444; scrollbar-base-color: #333;
...
::-webkit-scrollbar-thumb:hover { min-height:5px; min-width:5px; background-color: #444; }
::-webkit-scrollbar-thumb:active { -webkit-border-radius:20px; background-color: #444; }
::-webkit-scrollbar-thumb {
    min-height:5px; min-width:5px; -webkit-border-radius:20px;
    ::-webkit-border-radius:1px; background-color: #444;
}
body > pre { color: #666; }
...
#dir_tree li { text-indent: 2em; line-height: 1.6em; cursor: default; color: #444; }
...
#logout a { display: inline-block; color: #444; line-height: 25px; padding: 0 4px; }
#logout a:hover { background: #444; color: #ddd; }
#contextmenu { position: absolute; top: 0; left: 0; background: #f9f9ff; color: #333; border: 1px solid #444; padding: 1px; }
#contextmenu span { display: block; line-height: 24px; text-indent: 20px; width: 80px; cursor: default; }
#contextmenu span:hover { background-color: #369; color: #f9f9ff; }
...
<script src="{$jquery}" type="text/javascript" charset="utf-8"></script>
<script src="https://cloud9ide.github.io/emmet-core/emmet.js" type="text/javascript" charset="utf-8"></script>
<script src="{$ace['core']}" type="text/javascript" charset="utf-8"></script>
<script src="{$ace['snippets-php']}" type="text/javascript" charset="utf-8"></script>
<script src="http://cdn.staticfile.org/ace/1.1.3/ext-searchbox.js" type="text/javascript" charset="utf-8"></script>
<script src="{$ace['ext-emmet']}" type="text/javascript" charset="utf-8"></script>
<script src="{$ace['ext-language']}" type="text/javascript" charset="utf-8"></script>
<script src="{$tip['js']}" type="text/javascript"></script>
<script type="text/javascript">
var load = false;
var curr_file = false;
...
langTools.addCompleter(tangideCompleter);
	...
	load = function(ele) {
        ...
        theEvent.srcElement = theEvent.srcElement || theEvent.target;
	    var curr = $(theEvent.srcElement);
	    if ( ele ) { curr = ele; }
	...
	$('#sider').bind('contextmenu', function(e){
	    ...
	    var theEvent = window.event || arguments.callee.caller.arguments[0];
        theEvent.srcElement = theEvent.srcElement || theEvent.target;
	    var target = $(theEvent.srcElement);
	    if ( target.is('span') ) {
	...
	//全屏按钮
	$('#logout>a:contains("全屏")').click(function(){
