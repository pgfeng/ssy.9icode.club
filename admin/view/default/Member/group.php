...
<div class="row" style="margin-top: 10px">
    ...
    <script type="text/javascript">
        BUI.use(['bui/grid', 'bui/data'], function (Grid, Data) {
            ...
            //默认的数据
                data =<php> echo json_encode($group); </php>,
            ...
            editing.on('accept', function (editing) {
                ...
                {
                    var url = '<{url('Member/group/edit')}>' + '?' + new Date().getTime();
                    $.post(url, {
                    ...
                    var url = '<{url('Member/group/add')}>' + '?' + new Date().getTime();
                        ...
                        buttons : [
                            {
                                ...
                                handler : function(){
                                    var url = '<{url('Member/group/del')}>' + '?' + new Date().getTime();
